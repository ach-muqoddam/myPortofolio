  ...
  return (
    <footer style={{ backgroundColor: 'var(--secondary-bg)', padding: '3rem 0', borderTop: '1px solid var(--border-color)' }}>
      <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        <h2 style={{ fontSize: '1.5rem', color: 'var(--primary)', marginBottom: '1rem', fontWeight: 'bold' }}>John Doe</h2>
        ...
        <p style={{ color: 'var(--muted-text)', fontSize: '0.875rem' }}>
          &copy; {new Date().getFullYear()} John Doe. All rights reserved. Built with React & Vite.
        </p>
      </div>
    </footer>
  );
